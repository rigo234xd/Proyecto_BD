...
def create_torneo(session: Session, nombre: str, fecha_inscrip: date, mesas_disp: int, competencia: str, inscripcion_id: int):
    torneo = Torneo(
        nombre=nombre,
...
def update_torneo(session: Session, torneo_id: int, nombre: str, fecha_inscrip: date, mesas_disp: int, competencia: str, inscripcion_id: int):
    ...
    if torneo:
        ...
        torneo.inscripcion = inscripcion_id
        session.commit()
    return torneo
